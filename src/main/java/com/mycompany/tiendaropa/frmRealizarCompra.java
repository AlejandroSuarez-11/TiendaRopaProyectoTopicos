...
import com.mycompany.tiendaropa.Util.HoverBotonUtil;
...
public class frmRealizarCompra extends javax.swing.JPanel {
    ...
    HoverBotonUtil.aplicarEfecto(btngenerar, Color.CYAN); 
    HoverBotonUtil.aplicarEfecto(btnlimpiar, Color.CYAN);
    HoverBotonUtil.aplicarEfecto(btnlimpiartabla, Color.CYAN); 
    HoverBotonUtil.aplicarEfecto(btnquitar, Color.CYAN);
    HoverBotonUtil.aplicarEfecto(btnnetopagar, Color.CYAN); 
    ...
    private void botonhActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
    }                                      

    private void botonmActionPerformed(java.awt.event.ActionEvent evt) {                                       
        // TODO add your handling code here:
    }                                      
    ...
    private void btnnetopagarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
        double sumatoria;
        double sumatorial = 0;
   ...
   private void reproducirSonido() {
    try {
        // Abrimos el archivo con el efecto de sonido
        URL url = getClass().getResource("/moneda.wav");
        
        // Si el archivo existe
        if (url != null) {
            // Se crea una linea o clip de salida de audio del SO
            Clip clip = AudioSystem.getClip();
            clip.open(AudioSystem.getAudioInputStream(url));
            
            // Comienza audio desde el segundo 0
            clip.setFramePosition(0); 
            clip.start();

            
            clip.addLineListener(event -> {
                // Si el sonido se detiene se cierra la linea para liberar recurssos
            ...
            System.err.println("No se encontró el archivo moneda.wav");
        }
    } catch (Exception e) {
    }
}
